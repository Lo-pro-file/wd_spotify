...
async def sng(bot, message):          
          ...
          try:
            ...
            await message.reply(rpl)
             ...
             await message.reply_text(f"lyrics does not found for `{song}` ", quote = True, reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("❣️ ᴜᴘᴅᴀᴛᴇs", url = f"https://t.me/Opleech")]]))
          finally:
            await message.reply("Check out @Spotify_Pro_v1_bot(music)  @Opleech(News)")
